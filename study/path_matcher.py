...
def test_path_match():
    ...
    patterns = ["/", "/aa", "/aa/", "/bb/*", "/bb", "/cc/{id}/profile", "/cc/df/profile", "/cc/de/*", "/dd/{id}",
                "/dd/{id}/", "/ee/aa/bb/"]
    path_dict = {}
    for pattern in patterns:
        path_dict[pattern] = pattern
    ...
    deep_path2 = '10.10.65.21:80/GET/' + '/'.join(
        [str(i) for i in range(PATH_MAX_DEPTH)])  # ignore deep > PATH_MAX_DEPTH
